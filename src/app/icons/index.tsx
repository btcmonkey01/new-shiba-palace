export const MetaMaskIcon = () => {
  ...
  return <div className="w-[30px] absolute top-0 right-0">
    <svg stroke="white" strokeWidth={2} xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" id="Layer_1" x="0" y="0" version="1.1" viewBox="0 0 318.6 318.6">
      <style>
